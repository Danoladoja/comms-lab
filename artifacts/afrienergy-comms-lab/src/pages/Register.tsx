      ...
      <div className="w-full max-w-md bg-card border border-border rounded-3xl shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-500">
        <div className="p-8 md:p-10 space-y-8">
          ...
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div>
              <h1 className="text-2xl font-display font-bold text-foreground">Join Afrienergy</h1>
              <p className="text-muted-foreground mt-2">Create an account to start your learning journey.</p>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="firstName" placeholder="Sarah" required className="bg-background" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="lastName">Last Name</Label>
                  <Input id="lastName" placeholder="Adeyemi" required className="bg-background" />
                </div>
              </div>
