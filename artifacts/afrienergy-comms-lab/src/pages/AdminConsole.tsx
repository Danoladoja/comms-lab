  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-12">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Manage programmes, watch how a cohort is doing, and handle enrolments, people and recordings.</p>
      </div>

      {/* Six tabs are well over 600px wide; a phone is 375. Without the scroll
