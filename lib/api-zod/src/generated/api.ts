...
export const GetCohortProgressResponse = zod.object({
  ...
  "onExtraTime": zod.int(),
  "waived": zod.int(),
  "kind": zod.enum(['class', 'simulation']),
  "attended": zod.int(),
  "viaLive": zod.int(),
  "viaReplay": zod.int(),
  ...
  "simulationDone": zod.int(),
  "simulationNotDone": zod.int(),
  "hasQuiz": zod.boolean(),
  "quizPassed": zod.int(),
  "hasAssignment": zod.boolean(),
  "submitted": zod.int(),
 ...
 */
export const GetStudioCohortParams = zod.object({
  "programId": zod.coerce.number().int()
})
...
export const GetStudioCohortResponse = zod.object({
  ...
  "name": zod.string(),
  "email": zod.string(),
  "standing": zod.enum(['waiting', 'not-started', 'in-progress', 'finished', 'missed']),
