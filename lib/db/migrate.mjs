 ...
 *
 * The app now does this for itself at startup, before it serves anything, so
 * running this by hand is no longer part of deploying. It is kept for the times
 * you want to migrate deliberately and watch it happen — bringing a restored
 * backup up to date, or checking a new migration against a copy before it goes
 * anywhere near the cohort.
 */
